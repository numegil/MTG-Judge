...
+ (id)loadingViewInView:(UIView *)aSuperview
{
	...
	loadingView.loadingLabel =
		...
		autorelease];
	loadingView.loadingLabel.text = NSLocalizedString(@"Downloading...", nil);
	...
	CGFloat totalHeight =
		loadingView.loadingLabel.frame.size.height +
	...
	activityIndicatorRect.origin.y =
		loadingView.loadingLabel.frame.origin.y + loadingView.loadingLabel.frame.size.height;
